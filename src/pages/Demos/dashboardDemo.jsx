      ...
      <div className="demo-content">
        <div className="demo-text">
          ...
          <p className="demo-description">
            Plataforma web colaborativa desarrollada para la administración de una aplicación de citas.
            Permite configurar roles de acceso y citas en tiempo real. Este proyecto fue realizado en equipo,
            integrando diseño UX/UI y desarrollo front-end con enfoque en usabilidad y rendimiento.
          </p>
